  ...
  <UFooter>
    ...
    <template #right>
      ...
      <UButton
        color="neutral"
        variant="ghost"
        to="http://qm.qq.com/cgi-bin/qm/qr?_wv=1027&k=A3MAv6d6GbbyIb-ckMdDOssbrW1XD6ST&authKey=m%2F%2FWqT31Nas1I4PZudIosC22Qv3Hkyylzp%2FCzlIn7Z0GZ2rdkKKuSEnv99rVL3th&noverify=0&group_code=151374817"
        target="_blank"
        aria-label="QQ"
      >
        <template #leading>
